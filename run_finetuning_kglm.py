...
if __name__ == '__main__':
    ...
    train_dataset = KGLMDataset(DB_PORT, 'KGLM', 'train', neighborhood=not args.drop_neighborhood)
    ...
    valid_dataset = KGLMDataset(DB_PORT, 'KGLM', 'valid', neighborhood=not args.drop_neighborhood)
