...
from lm_experiments_tools.trainer_weighted_loss import Trainer
...
parser.add_argument('--entity_tokens_weight', default=1., type=float, help='multiplier of entity tokens loss')
...
if __name__ == '__main__':
    ...
    entity_sep_id = tokenizer.encode('[SEP-2]')[0]
    model.entity_sep_id, model.entity_tokens_weight = entity_sep_id, args.entity_tokens_weight
